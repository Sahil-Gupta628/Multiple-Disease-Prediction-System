...
def predict_kidney_disease(kidney_disease_model):
    ...
    st.image("images/KidneyImg.jpg", width=600)
    ...
    with col3:
        specific_gravity = st.number_input(
            'Specific Gravity', value=1.02, step=0.01)
    with col4:
    ...
    with col2:
        white_blood_cell_count = st.number_input(
            'White Blood Cell Count', value=8000)
    with col3:
    ...
    with col1:
        coronary_artery_disease = st.radio(
    ...
    if st.button("Kidney Disease Test Result"):
        ...
        if prediction[0] == 1:
            kidney_diagnosis = "The person is predicted to have Kidney Disease"
        else:
            kidney_diagnosis = "The person may not have Kidney Disease"
